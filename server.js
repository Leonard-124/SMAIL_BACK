...
// ─── CORS ─────────────────────────────────────────────────────────────────────
const allowedOrigins = (process.env.ALLOWED_ORIGINS || "http://localhost:5173" || "almofarmproducesuppliers.com")
  .split(",")
  .map((o) => o.trim());
...
// app.use("/api/v1/auth", authLimiter, authRoutes);
// app.use("/api/v1/prodCat", generalLimiter, prodCatRoute);
// app.use("/api/v1/admin", adminLimiter, adminRoutes); // ✅ NEW: Admin routes
